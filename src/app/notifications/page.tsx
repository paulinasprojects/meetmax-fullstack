...
const NotificationsPage = () => {
  ...
  return (
    <div className="space-y-4">
      <Card className="xl:w-[760px] lg:w-[560px] md:w-[700px] max-sm:w-[390px]">
          ...
          <ScrollArea className="h-[calc(100vh-12rem)]">
            {notifications.length === 0 ? (
              ...
              notifications.map((notification) => (
                <div key={notification.id}   className={`flex items-start gap-4 p-4 border-b hover:bg-muted/25 transition-colors ${
